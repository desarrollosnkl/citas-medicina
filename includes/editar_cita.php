        ...
        <div id="login-row" class="row justify-content-center align-items-center">
            <div id="login-column" class="col-md-6">
                <div id="login-box" class="col-md-12">
                    ...
                    <h3 style="color: crimson;" class="text-center">Editar Cita del Paciente <?php echo $usuario['paciente']; ?></h3>
                    <br>
                    ...
                    <div class="mb-3">
                        ...
                        <button type="submit" id="form" name="form" class="btn btn-outline-primary">Editar</button>
                        <a href="../views/citas.php" class="btn btn-outline-danger">Cancelar</a>
