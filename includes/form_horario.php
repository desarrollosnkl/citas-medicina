            ...
            <div class="modal-body">
                ...
                <form action="../includes/functions.php" method="POST">
                    ...
                    <div class="form-group">
                        <label style="color: crimson;" for="nombre" class="form-label">Dias de atencion medica:</label>
                        <input type="text" id="dias" name="dias" class="form-control" required placeholder="Dia de atencion medica">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <a href="horarios.php" class="btn btn-outline-danger">Cancelar</a>
