            ...
            <div class="modal-body">
                ...
                <form action="../includes/functions.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="number" id="cedula" name="cedula" class="form-control" required placeholder="Ingrese numero de Folio">
                    </div>

                    <div class="form-group">
                        <label for="nombre" class="form-label">Nombre/Apellido*</label>
                        <input type="text" id="nombres" name="nombres" class="form-control" required placeholder="Ingrese su nombre y apellido">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="telefono" id="telefono" class="form-control" required placeholder="Ingrese su numero de telefono">
                    </div>
                   ...
                   <!-- <div class="form-group">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="submit" value="Guardar" id="register" class="btn btn-outline-primary" name="registrar">
                        <a href="medicos.php" class="btn btn-outline-danger">Cancelar</a>
