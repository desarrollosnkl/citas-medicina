        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
             ...
             <form  action="registros.php" method="POST">
                            ...
                            <input type="text"  id="nombre" name="nombre" class="form-control" require placeholder="Ingrese su nombre">
                            </div>
                            <div class="form-group">
                      ...
                      <br>
                               ...
                               <input type="submit" value="Guardar" id="register" class="btn btn-outline-primary" 
                               name="registrar">
