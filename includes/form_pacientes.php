            ...
            <div class="modal-body">
                ...
                <form action="../includes/functions.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" id="nombre" name="nombre" class="form-control" required placeholder="Ingrese su nombre y apellido">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="telefono" id="telefono" class="form-control" required placeholder="Ingrese su telefono">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <a href="pacientes.php" class="btn btn-outline-danger">Cancelar</a>
